...
Only the latest release (the build served at [game3.niclaslindstedt.se](https://game3.niclaslindstedt.se/)) and the current `main` branch receive security fixes. There are no maintained older lines.

## Reporting a vulnerability

**Do not open a public issue for a security problem.**

Report privately via [GitHub Security Advisories](https://github.com/niclaslindstedt/game3/security/advisories/new) ("Report a vulnerability" on the repository's Security tab). If you cannot use GHSA, email the maintainer at the address on [github.com/niclaslindstedt](https://github.com/niclaslindstedt).
