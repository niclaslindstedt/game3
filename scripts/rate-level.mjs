...
const args = parseArgs(
  process.argv.slice(2),
  {
    ...
    biome: { kind: "string", default: "taiga", help: "which coast (taiga, mangrove)" },
  ...
  "usage: npm run rate -- [--seed n | --seeds a,b,c | --count n] [--biome taiga|mangrove] [--track coast|circuit] [--tricks] [--hour h] [--season s] [--weather w] [--wind m/s] [--swell m] [--stats] [--campaign] [--json path]",
);
