...
const args = parseArgs(
  ...
  "usage: npm run difficulty -- [--seed n] [--biome taiga|mangrove] [--track coast|circuit] [--tricks] [--swell m] [--hour h] [--season s] [--weather w] [--wind m/s] [--scale px/m] [--campaign] [--out name]",
);
