...
| `detail`  | The picture's DETAIL row: `low`, `medium` or `high` — the spray off the hull, the sea life under it and how thickly the shore is planted, as one choice.                                                                             |
