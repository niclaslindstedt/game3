...
| `airTime`                                                       | Seconds of AIR TIME: the flights that counted, summed whole. A hull clear of the water for less than `flight.airCounts` = 0.5 s did not go anywhere — in a head sea it does that a fifth of the steps — so those are not air. |
| `bestAir`                                                       | The longest single flight of the run, s, on the same line (`progress.bestAir`).                                                                                                                                               |
