...
pub const WINDOW_TITLE: &str = "Sea Haven";
...
/// nobody has ever seen, while the executable is `seahaven` — so the folder
...
pub const APP_DIR_NAME: &str = "seahaven";
