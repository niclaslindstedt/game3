...
/// behaviour: "Hide Sea Haven" is localized by the system, and
...
/// them ⌘C and ⌘V do nothing anywhere in the window, including on the
/// developer page's COPY REPRO LINK and on the number fields beside it.
