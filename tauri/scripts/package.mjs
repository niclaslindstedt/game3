...
//
// …each renamed to `seahaven-<version>-<os>-<arch>.<ext>`, so a release page
// lists one shape of name across three platforms rather than the bundler's own
// `Sea Haven_0.1.0_amd64.AppImage`, which has a space in it.
//
// Usage:
...
/**
 * `seahaven-<version>-<os>-<rest>`, from the bundler's own
