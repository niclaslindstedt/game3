...
//! THE MENU BAR, BUILT — the effects half of `seahaven_shell::menu`, which
...
use seahaven_shell::config::{site_link, SHELL_COMMAND};
use seahaven_shell::menu::{menu_bar, target_of, Entry, Native, Target};
