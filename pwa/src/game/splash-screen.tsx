...
// the app's own wave arrives in the space it left, draws itself, SEA HAVEN
// rises under it, and only then does the card ask for a press. Then it waits.
 ...
 * `ready` is beat two proper — the crest arriving, drawing itself, the name
