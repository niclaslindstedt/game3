...
//
// A polar shore has NO TREES and NO STONE, and its ladder is a few
// centimetres high: everything on it grows flat to the ground out of the
// wind, in cushions and mats in the firn, and what stands up over the
// rider's head is ICE, not wood. The ladder itself is in `flora-defs.ts`'s
// header with the other two coasts'.
...
export const ARCTIC_FLORA: readonly FloraSpec[] = [
  {
    ...
    habitat: {
      // Wholly under the water, on the bed off the ice foot: its crown is
  ...
  },
  {
    ...
    look: {
      ...
      // the front's calvings on the firn, and the tideline of a glacier
    ...
    habitat: {
      // Across the waterline and the wet firn just above it.
  ...
  },
  {
    ...
    habitat: {
      // Wet ground: the flats behind the firn and the melt along the
  ...
  },
  {
    ...
    look: {
      ...
      // coast in the spring and the loudest thing on the ice foot at any
  ...
  },
  {
    ...
    look: {
      ...
      // taiga's sallow, flat to the firn.
      form: "bush",
  ...
  },
  {
    ...
    habitat: {
      // The wind-exposed ridges of the ice foot.
      ground: { min: 1, max: 15 },
  ...
  },
  {
    ...
    look: {
      ...
      bare: 0,
      stem: 0x7a8a5a,
      // Yellow, on the barest firn: the one warm colour on the coast.
      stemHigh: 0xe8d060,
      leafLit: 0xe6d466,
      leafDark: 0x8a9a5a,
    },
  ...
  },
  {
    ...
    look: {
      ...
      // in a hollow of the ice foot, and up on the glacier's surface the
