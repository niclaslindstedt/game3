 ...
 *
 * The bank is static data, and almost nothing on the water is: a landing off
 * a wave at 4 m/s of descent and one off a ramp at 11 are the same EVENT and
...
export type PlayShape = {
  ...
  pitch?: number;
  /** Multiply every duration. A big splash rings longer than a small one. */
  stretch?: number;
