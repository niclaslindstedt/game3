...
//     slap, a splash, a bubble, a chime. Everything in the bank.
...
//     engine, the pump, the spray, the wind and the sea are all layers.
 ...
 * falls 3 dB an octave (spray, the wind, a sheet of water); brown falls 6
 * (a swell, distant surf, the body of an impact). */
 ...
 * broken speaker rather than as water.
 *
 ...
 * rate — and the reason a spray hiss does not scream on a phone.
 *
