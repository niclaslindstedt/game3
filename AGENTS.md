...
| Icons, favicon, `og.png`                                 | `make icons`                  | `tests/identity_test.ts` holds the palette; an `app_mark_test` holding the SVG to `app-mark.ts` is OWED |
