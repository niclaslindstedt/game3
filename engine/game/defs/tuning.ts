...
//
// Seven blocks are stated NEXT DOOR and folded in below under the names
...
export const TUNING = {
   ...
   * the same water, stated next door in `defs/tricks.ts` and folded in
   * here. Its own header carries the ladder they make. */
  tricks: TRICKS,
