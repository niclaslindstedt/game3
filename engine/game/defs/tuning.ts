...
export const TUNING = {
  ...
  /** THE TUCK and FLIGHT, stated next door (`defs/flight.ts`) — the air
   * over the water and the rider folded down behind the bars, which is
   * one subject with one owner and one lab. */
  tuck: TUCK,
  flight: FLIGHT,
  ...
  tricks: {
     ...
     * Three hundred is the purse of a 2.8-second flight (the curve above
     * integrated: 174 points for two seconds, 354 for three, 571 for four),
     * which is what a flip should be worth against the flight that carried
     * it: a good jump's worth on its own, and not so much more that the air
     * stops counting. */
    flipPoints: 300,
