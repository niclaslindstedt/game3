...
| `shore.ts` | **The coastline.** The shoreline polyline for the biome — the taiga's low bedrock slabs, boulder fields, sand pockets and the skerries offshore — and the classifier behind `level.surfaceAt`. |
