...
//
// NO GAME CENTER HERE. The sibling game this came from names the player with
// it; Sea Haven does not, so there is nothing to authenticate and nothing to
// sign into. The save follows the Apple ID the device is already signed into,
// which is the whole of what iCloud key-value storage needs.
//
