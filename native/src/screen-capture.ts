...
//
// The website owns the feature, as always: ENTER takes the picture, composites
// the HUD into it, stamps the mark and files it in the gallery
// (pwa/src/game/screenshots.ts). What a phone adds is a SECOND shutter — the
...
// its own in the roll behind GALLERY — signed, with the clock and the gate
// count as they stood. Neither is a copy of the other, and neither is lost.
//
